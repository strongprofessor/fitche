...
type ButtonIcon = 'image' | 'video' | 'headphones' | 'file-text' | 'link' | 'box' | 'calendar' | 'gift' | 'tag' | 'clock' | 'heart' | 'message-circle' | 'credit-card';
                  ...
                  <View style={styles.settingsSection}>
                    ...
                    <View style={styles.toggleItem}>
                      ...
                      <Switch 
                        ...
                        onValueChange={() => toggleProfileSetting('showLocation')}
                      />
                    </View>
                  </View>
